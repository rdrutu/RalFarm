...
export default function PlotMapSelector({ onPlotSelected, initialPosition = [44.4268, 26.1025] }: PlotMapSelectorProps) {
  ...
  // Funcție pentru comutarea tipului de hartă
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Map Layer Controls */}
      <div className="flex items-center space-x-2">
        <span className="text-sm font-medium text-gray-700">Tip hartă:</span>
