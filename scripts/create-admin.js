...
// Funcție pentru verificarea utilizatorilor existenți
async function listUsers() {
  ...
  if (users.length === 0) {
    ...
    console.log('💡 Rulează: node scripts/create-admin.js create');
    return;
  }
...
async function main() {
  ...
  switch (command) {
    ...
    default:
      ...
      console.log('  node scripts/create-admin.js create  # Creează super admin');
      console.log('  node scripts/create-admin.js list    # Listează utilizatorii existenți');
  }
}
